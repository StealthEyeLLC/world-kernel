...
var tests = new List<(string Name, Func<Task> Run)>
{
    ...
    ("campaign2.outcome_vectors", Campaign2ExecutionTests.OutcomeVectorsAsync),
    ("campaign3.observable_attestation_hard_gates", Campaign3Tests.ObservableAttestationsAsync),
    ("campaign3.p0_composer_exact_contract", Campaign3P0ComposerTests.ExactContractAsync),
    ("campaign3.outcome_vectors", Campaign3ExecutionTests.OutcomeVectorsAsync),
    ("campaign3.science_authorization_hard_gate", Campaign3BoundaryTests.ScienceAuthorizationAsync),
    ...
    ("postgres.projection_not_raw_evidence", () => DatabaseTests.ProjectionNotRawEvidenceAsync(secretFile)),
