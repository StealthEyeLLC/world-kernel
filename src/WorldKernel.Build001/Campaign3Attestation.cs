...
/// <summary>
/// Validates Campaign 3 attestations from observable product controls. It deliberately
/// does not treat an unavailable private OpenAI deployment identifier as evidence.
/// </summary>
public static class Campaign3Attestation
{
    public const string ProductSchema = "world-kernel-build001-campaign3-product-attestation-v1";
    public const string FreshInvocationSchema = "world-kernel-build001-campaign3-fresh-invocation-v1";
    public const string ProductMethodVersion = "campaign3-chatgpt-observable-controls-v1";
    public const string FreshInvocationMethodVersion = "campaign3-temporary-chat-isolation-v1";
    public const string InvalidationRulesVersion = "campaign3-trial-invalidation-v1";
    ...
    public static bool PassesP0(JsonElement root)
    {
        ...
        return String(root, "schema") == ProductSchema &&
               ...
               String(value, "subject_mode") == "Chat" &&
               String(value, "workspace_type") == "Business" &&
               String(value, "memory_state") == "not_used_or_created_by_temporary_chat" &&
               IsTrue(value, "account_memory_enabled") &&
               IsTrue(value, "record_history_reference_enabled") &&
               EmptyPersonalizationIsFrozen(value) &&
               String(value, "base_style_and_tone") == "Default" &&
               DefaultStyleCharacteristics(value) &&
               IsFalse(value, "fast_answers_enabled") &&
               ...
               IsSha256(value, "trial_output_contract_sha256") &&
    ...
    public static bool PassesP5(JsonElement root, JsonElement p0)
    {
        ...
        return PassesP0(p0) &&
               ...
               String(root, "trial_output_contract_sha256") == String(configuration, "trial_output_contract_sha256");
    }
    ...
    private static bool EmptyPersonalizationIsFrozen(JsonElement configuration) =>
        String(configuration, "custom_instructions", "state") == "identically_frozen" &&
        String(configuration, "custom_instructions", "sha256") == "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855" &&
        Number(configuration, "custom_instructions", "field_count") == 4;

    private static bool DefaultStyleCharacteristics(JsonElement configuration) =>
        String(configuration, "style_characteristics", "warm") == "Default" &&
        String(configuration, "style_characteristics", "enthusiastic") == "Default" &&
        String(configuration, "style_characteristics", "headers_and_lists") == "Default" &&
        String(configuration, "style_characteristics", "emoji") == "Default";

    private static bool IsNonEmptyString(JsonElement root, params string[] path) =>
        String(root, path) is { Length: > 0 } value &&
