...
if(-not $output.StartsWith($campaignRoot,[StringComparison]::OrdinalIgnoreCase)){throw 'Reset verification output escapes Campaign 2.'}
...
$result=[ordered]@{
  schema='world-kernel-build001-campaign2-independent-reset-verification-v1'
