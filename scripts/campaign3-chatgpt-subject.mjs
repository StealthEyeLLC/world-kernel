...
if (!sdkPath || !requestPath || !outputPath) {
  throw new Error('usage: campaign3-chatgpt-subject.mjs <eyebrowse-sdk> <request-json> <output-json> [pipe]');
}
...
if (request.schema !== 'world-kernel-build001-campaign3-subject-request-v1') throw new Error('invalid request schema');
