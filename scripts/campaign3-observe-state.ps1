...
if (-not $output.StartsWith($campaignRoot, [StringComparison]::OrdinalIgnoreCase)) { throw 'State observation output escapes Campaign 3.' }
...
$result = [ordered]@{
    schema = 'world-kernel-build001-campaign3-state-observation-v1'
