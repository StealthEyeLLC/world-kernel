...
if (-not $ArtifactDirectory) {
    $ArtifactDirectory = Join-Path $repoRoot 'experiments\build001\campaign-3\preflight\regression'
}
...
if ($LASTEXITCODE -ne 0) { throw "Campaign 3 regression tests exited with $LASTEXITCODE" }
