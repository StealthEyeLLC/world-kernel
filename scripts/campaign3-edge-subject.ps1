...
public static class Campaign3User32
{
...
if ($request.schema -ne 'world-kernel-build001-campaign3-subject-request-v1') { throw 'Invalid subject request schema.' }
...
try {
    ...
    [Campaign3User32]::ShowWindowAsync($edgeProcess.MainWindowHandle, 3) | Out-Null
    [Campaign3User32]::SetForegroundWindow($edgeProcess.MainWindowHandle) | Out-Null
